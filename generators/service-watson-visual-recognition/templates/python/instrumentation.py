...
if IBMCloudEnv.getString('watson_visual_recognition_api_key'):
    iam_url = 'https://iam.stage1.bluemix.net/identity/token' if 'gateway-s.' in IBMCloudEnv.getString('watson_visual_recognition_url') else 'https://iam.bluemix.net/identity/token'
