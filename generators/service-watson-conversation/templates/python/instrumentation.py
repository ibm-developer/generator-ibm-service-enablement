...
if IBMCloudEnv.getString('watson_conversation_apikey'):
    iam_url = 'https://iam.stage1.bluemix.net/identity/token' if 'gateway-s.' in IBMCloudEnv.getString('watson_conversation_url') else 'https://iam.bluemix.net/identity/token'
