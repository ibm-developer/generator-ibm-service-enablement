...
if IBMCloudEnv.getString('watson_tone_analyzer_apikey'):
    iam_url = 'https://iam.stage1.bluemix.net/identity/token' if 'gateway-s.' in IBMCloudEnv.getString('watson_tone_analyzer_iam_serviceid_crn') else 'https://iam.bluemix.net/identity/token'
