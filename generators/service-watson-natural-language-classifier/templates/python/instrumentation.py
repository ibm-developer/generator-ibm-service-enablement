...
if IBMCloudEnv.getString('watson_natural_language_classifier_apikey'):
    iam_url = 'https://iam.stage1.bluemix.net/identity/token' if 'gateway-s.' in IBMCloudEnv.getString('watson_natural_language_classifier_url') else 'https://iam.bluemix.net/identity/token'
