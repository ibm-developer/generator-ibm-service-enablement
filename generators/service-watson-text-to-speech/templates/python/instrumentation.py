...
if IBMCloudEnv.getString('watson-text-to-speech_apikey'):
    iam_url = 'https://iam.stage1.bluemix.net/identity/token' if 'gateway-s.' in IBMCloudEnv.getString('watson_text-to-speech_iam_serviceid_crn') else 'https://iam.bluemix.net/identity/token'
