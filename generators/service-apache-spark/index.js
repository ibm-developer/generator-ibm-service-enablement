...
module.exports = class extends Generator {
	...
	_addLocalDevConfig(){
		...
		let localDevConfigString = template({
			clusterMasterUrl: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].cluster_master_url,
			tenantId: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].tenant_id,
			tenantSecret: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].tenant_secret
		})
