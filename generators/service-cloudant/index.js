...
module.exports = class extends Generator {
	...
	_addLocalDevConfig(){
		...
		let localDevConfigString = template({
			username: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME][0].username,
			password: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME][0].password,
			url: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME][0].url
		})
