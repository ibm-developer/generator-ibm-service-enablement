...
module.exports = class extends Generator {
	...
	_addLocalDevConfig(){
		...
		let localDevConfigString = template({
			...
			writerUserId:this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].writer.userid,
			writerPassword:this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].writer.password,
			readerUserId: this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].reader.userid,
			readerPassword:this.context.bluemix[SCAFFOLDER_PROJECT_PROPERTY_NAME].reader.password
		});
