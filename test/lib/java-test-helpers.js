...
test_maven.prototype.assertDependency = function(exists, scope, groupId, artifactId, version, exclusions) {
  ...
  var desc = exists ? ' contains' : ' does not contain';
...
var constructMavenRegex = function(scope, groupId, artifactId, version, exclusions) {
...
var constructGradleRegex = function(scope, groupId, artifactId, version, exclusions) {
  groupId = groupId.replace(/\./g, '\\.');
  artifactId = artifactId.replace(/\./g, '\\.');
...
test_liberty.prototype.assertFeature = function(exists, name) {
  var check = exists ? assert.fileContent : assert.noFileContent;
  var desc = exists ? 'generators' : 'does not generate';
