	...
	it('Can run generation with no services', (done) => {
		...
		helpers
			...
			.then((tmpDir) => {
				...
				// Gopkg.toml doesn't have any SDKs
				// yassert.noFileContent(GOPKG_TOML, 'appid');
				// yassert.noFileContent(GOPKG_TOML, 'cloudant');
				// yassert.noFileContent(GOPKG_TOML, 'dashdb');
